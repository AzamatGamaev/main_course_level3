...
public class Tester {
    ...
    private static <T> void invokeMethods(Class<T> testClass) throws ReflectiveOperationException {
        ...
        PriorityQueue<Method> testQueue = new PriorityQueue<Method>((o1, o2) -> o2.getAnnotation(Test.class).value().getPriority() - o1.getAnnotation(Test.class).value().getPriority());
